...
namespace PinkCore::UI
{
	void PinkCoreFlowCoordinator::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling)
	{
		if (firstActivation)
		{
			pinkCoreSettingsViewController = reinterpret_cast<HMUI::ViewController*>(Helpers::CreateViewController<PinkCoreSettingsViewController*>());
			pinkCoreDonationViewController = reinterpret_cast<HMUI::ViewController*>(Helpers::CreateViewController<PinkCoreDonationViewController*>());
